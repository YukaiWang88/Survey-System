...
const areEqual = (prevProps, nextProps) => {
  const prev = prevProps.responses;
  const next = nextProps.responses;
...
const WordCloudResults = React.memo(WordCloudResultsComponent, areEqual);

export default WordCloudResults;

// const WordCloudResults = ({responses}) => {
